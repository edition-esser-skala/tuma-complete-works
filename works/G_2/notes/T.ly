...
G-IIStabatTenore = {
  \relative c' {
    ...
    a4. b16[ c] d2
    e a,4 r\fermata
    \tempoG-IIPerTransivit d8 b c d d8. d16 d4
...
G-IIStabatTenoreLyrics = \lyricmode {
  Sta --
  bat ma -- ter
  do -- lo -- ro -- _
  _ _ _
...
G-IIOQuamTenoreLyrics = \lyricmode {
  O quam
  tri -- stis
  fu -- it
  il -- la
...
G-IIQuisEstTenoreLyrics = \lyricmode {
...
G-IIProPeccatisTenore = {
  \relative c' {
    ...
    g4. g8 g4 r\fermata
    \tempoG-IIViditSuum g4. c8 f,4 f
    r2 b4. as8 %20
    g4( c) c r
    r2 c4\p c
    d d es es
    es(\crescE d8[ c)] d2
    \tempoG-IIDumEmisit r4 d8\fE d c16([ h)] c8 r4 %25
    r e8 e f c r4
    \tempoG-IISpiritum c4.\p h8 c r r4\fermata \bar "||" %27 finis
  }
}

G-IIProPeccatisTenoreLyrics = \lyricmode {
...
G-IIEiaMaterTenoreLyrics = \lyricmode {
  E -- ia,
  ma -- ter,
  fons a --
  mo -- ris,
...
G-IISanctaMaterTenoreLyrics = \lyricmode {
  San -- cta
  ma -- ter, san -- cta
  ma -- ter, i -- stud
  a -- gas, cru -- ci --
...
G-IIFacMeTenoreLyrics = \lyricmode {
  Fac me __ %4
  te -- cum %5
  pi -- e
  fle --
...
G-IIVirgoTenoreLyrics = \lyricmode {
  Vir -- go %3
...
G-IIChristeTenore = {
  \relative c' {
    ...
    c c, c' c b4. cis8
    d2 d4. d8
    d4 r \tempoG-IIAmen r2 %65
    es2.( d8[ c)]
    d1\fermata \bar "|." %67 FINIS
  }
}

G-IIChristeTenoreLyrics = \lyricmode {
  Chri -- ste, Chri -- ste,
