...
G-IIStabatSoprano = {
  \relative c' {
    ...
    d c4 b8[ a] b4~
    b2 a4 r\fermata
    \tempoG-IIPerTransivit b8 d c b16([ a)] b[ g a b] c[ d e fis]
    g8. g,16 g4 r2 %30
...
G-IIStabatSopranoLyrics = \lyricmode {
  Sta -- bat
  ma -- ter do --
  lo -- ro --
  _ sa, do --
...
G-IIOQuamSopranoLyrics = \lyricmode {
  Et af -- %2
  fli -- cta
  be -- ne --
  di -- cta %5
...
G-IIQuisEstSopranoLyrics = \lyricmode {
  Quis est
  ho -- mo, qui non fle --
  _ _
  _ _ ret, ma -- trem
...
G-IIProPeccatisSoprano = {
  \relative c' {
    ...
    d d, r h' c4 es,
    d4. d8 c4 r\fermata
    \tempoG-IIViditSuum c'4. c8 c8([ b)] b4
    b8([ c)] c([ des)] \once \tieDashed des2~ %20
    des4 c8[ b] as4 r
    c\p c c2
    h c4 c
    c2\cresc h
    \tempoG-IIDumEmisit r4 h8\f h c16([ d)] es8 r4
    r c8 c c16([ b)] c8 r4
    \tempoG-IISpiritum g8\p r g r g r r4\fermata \bar "||"
  }
}

G-IIProPeccatisSopranoLyrics = \lyricmode {
...
G-IIEiaMaterSopranoLyrics = \lyricmode {
  E -- ia,
  ma -- ter, fons __
  _ a --
  mo -- ris, fons __
...
G-IISanctaMaterSopranoLyrics = \lyricmode {
  San -- cta ma -- ter,
  san -- cta ma -- ter,
  i -- stud a -- gas, i -- stud
  a -- gas, cru -- ci --
...
G-IIFacMeSopranoLyrics = \lyricmode {
  Fac me, __
  fac me
  te --
  cum
...
G-IIVirgoSopranoLyrics = \lyricmode {
  Fac, ut por -- tem %8
  Chri -- sti mor -- tem,
  pas -- si -- o -- %10
  nis __ fac con --
...
G-IIChristeSoprano = {
  \relative c' {
    ...
    \tempoG-IIFacUt g4\fE g b4. a16([ g)]
    c4 es fis,2
    g8 a b([ c] d) a d4~ %15
    ...
    fis a( b[ a16 g] a4.) a8
    g4 r \tempoG-IIAmen r d'~ %65
    d c8[ h] c2~
    c4 h8[ a] h2\fermata \bar "|." %67 FINIS
  }
}

G-IIChristeSopranoLyrics = \lyricmode {
  Chri -- ste,
