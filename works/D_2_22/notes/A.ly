...
D-II-XIIMiserereAltoLyrics = \lyricmode {
  Mi -- se -- re -- re,
  mi -- se --
  re -- re, mi -- se --
  re -- re,
...
D-II-XIIAmpliusAltoLyrics = \lyricmode {
  Ab in -- %5
  i -- qui --
  ta -- te
  me -- a,
...
D-II-XIITibiSoliAlto = {
  \relative c' {
    ...
    fis2 g~ \noBreak
    g r\fermata
    \tempoD-II-XIIUtIustificeris g8 g f g g[ as16 g] f[ d g f] \noBreak
    ...
    as as f as f4. f8 %20
    g g es g es4. g8
    es es r4 r \tempoD-II-XIICumIudicaris c
    d es8([ f)] g2
    g r\fermata \bar "||" %24 finis
  }
}

D-II-XIITibiSoliAltoLyrics = \lyricmode {
  Pec -- ca -- %2
  _
  _ vi, pec --
  ca -- %5
...
D-II-XIIEcceEnimAltoLyrics = \lyricmode {
  Ec -- ce,
  ec -- ce
  e -- nim in
  in -- i -- qui --
...
D-II-XIIAspergesAltoLyrics = \lyricmode {
  A -- sper -- %5
  ges
  me hys --
  so --
...
D-II-XIIAudituiAltoLyrics = \lyricmode {
  Au --
  di -- tu -- i
  me -- o da --
  _
...
D-II-XIIAverteAltoLyrics = \lyricmode {
  A -- ver -- te, a --
...
D-II-XIINeProiciasAltoLyrics = \lyricmode {
  Red -- de %29
  mi -- hi, %30
  red -- de
  mi -- hi lae --
...
D-II-XIIDomineAltoLyrics = \lyricmode {
  Do -- mi -- ne, Do -- _ %3
  _ _ _ mi --
  ne, %5
...
D-II-XIIQuoniamAltoLyrics = \lyricmode {
  Quo -- ni -- am
  si vo -- lu --
  is -- ses
  sa -- cri --
...
D-II-XIISacrificiumAltoLyrics = \lyricmode {
  Sa -- cri -- fi -- ci -- um %3
  De -- o, sa --
  cri -- fi -- ci -- um %5
  De -- o, De --
...
D-II-XIIBenigneAltoLyrics = \lyricmode {
  Be --
...
D-II-XIIGloriaAltoLyrics = \lyricmode {
  Glo -- ri -- a,
  glo -- ri -- a Pa -- tri,
  glo -- ri -- a,
  glo -- ri -- a Fi -- li -- o,
