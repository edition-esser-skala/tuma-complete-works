...
D-II-XIIMiserereSoprano = {
  \relative c' {
    \clef treble
    \key c \dorian \time 4/4 \autoBeamOff \tempoD-II-XIIMiserere
    es'4\fE c d8([ c]) d4
    r g,(\p as4.) as8
    g4\f c des4. des8
    des([ c)] c4 r c~\p
...
D-II-XIIMiserereSopranoLyrics = \lyricmode {
  Mi -- se -- re -- re,
  mi -- se --
  re -- re, mi -- se --
  re -- re, mi --
...
D-II-XIIAmpliusSoprano = {
  \relative c' {
    \clef treble
    \key g \minor \time 3/4 \autoBeamOff \tempoD-II-XIIAmplius
    R2.*5 %5
    r4 d'\pE d
    d( cis) c
    c( h) b
...
D-II-XIIAmpliusSopranoLyrics = \lyricmode {
  Ab in -- %6
  i -- qui --
  ta -- te
  me -- a,
...
D-II-XIITibiSoliSoprano = {
  \relative c' {
    \clef treble
    \key c \dorian \time 4/4 \autoBeamOff \tempoD-II-XIITibiSoli
    r4 g'8\p g c([ es)] c([ g)]
    c,4 c8 c'\f c2
    cis2. d4~
    d c2 b4~
    ...
    c2._( h8[ a]) \noBreak
    h2 r\fermata
    \tempoD-II-XIIUtIustificeris c4 d c8 es d4 \noBreak
    c b!~ b8 es d f
    ...
    es c r4 r \tempoD-II-XIICumIudicaris c
    h c c( h)
    c2 r\fermata \bar "||" %24 finis
  }
}

D-II-XIITibiSoliSopranoLyrics = \lyricmode {
  Ti -- bi so -- li, __
  so -- li pec -- ca --
  _ _
  _ _
...
D-II-XIIEcceEnimSoprano = {
  \relative c' {
    \clef treble
    \key g \minor \time 3/4 \autoBeamOff \tempoD-II-XIIEcceEnim
    d'4\fE d r
    r b a
    g8([ fis)] g4 d'
    es c a
...
D-II-XIIEcceEnimSopranoLyrics = \lyricmode {
  Ec -- ce,
  ec -- ce
  e -- nim in
  in -- i -- qui --
...
D-II-XIIAspergesSoprano = {
  \relative c' {
    \clef treble
    \key g \minor \time 2/1 \autoBeamOff \tempoD-II-XIIAsperges
...
D-II-XIIAspergesSopranoLyrics = \lyricmode {
  A -- %9
  sper -- %10
  ges me hys --
  so -- po, et __ mun --
...
D-II-XIIAudituiSoprano = {
  \relative c' {
    \clef treble
    \key es \major \time 3/4 \autoBeamOff \tempoD-II-XIIAuditui
    r4 r b'4\fE
...
D-II-XIIAudituiSopranoLyrics = \lyricmode {
  Au --
  di -- tu -- i
  me -- o
  da -- bis gau --
...
D-II-XIIAverteSoprano = {
  \relative c' {
    \clef treble
    \key g \minor \time 4/4 \autoBeamOff \tempoD-II-XIIAverte
    r4 r8 g''\fE es c r h
...
D-II-XIIAverteSopranoLyrics = \lyricmode {
  A -- ver -- te, a --
...
D-II-XIINeProiciasSoprano = {
  \relative c' {
    \clef treble
    \key b \major \time 3/4 \autoBeamOff \tempoD-II-XIINeProicias
    R2.*29 %29
    r4 c'\fE b %30
    a16([ g)] f8 r4 r
    r f' es
...
D-II-XIINeProiciasSopranoLyrics = \lyricmode {
  Red -- de %30
  mi -- hi,
  red -- de
  mi -- hi, red -- de
...
D-II-XIIDomineSoprano = {
  \relative c' {
    \clef treble
    \key es \major \time 4/4 \autoBeamOff \tempoD-II-XIIDomine
    ...
    R1*3 %10
    \tempoD-II-XIIEtOs r4 b8\fE d c f,16 a c8 es
...
D-II-XIIDomineSopranoLyrics = \lyricmode {
  Do -- _
  _ _ _ mi --
  ne,
...
D-II-XIIQuoniamSoprano = {
  \relative c' {
    \clef treble
    \key c \dorian \time 3/4 \autoBeamOff \tempoD-II-XIIQuoniam
    c'4.\fE d8 es4
    d c h
    c g r
    as2 as4
...
D-II-XIIQuoniamSopranoLyrics = \lyricmode {
  Quo -- ni -- am
  si vo -- lu --
  is -- ses
  sa -- cri --
...
D-II-XIISacrificiumSoprano = {
  \relative c' {
    \clef treble
    \key f \dorian \time 4/4 \autoBeamOff \tempoD-II-XIISacrificium
    R1*4
    c'4\fE c h h8 h %5
    c2.( h4)
    c r c8. c16 c4
...
D-II-XIISacrificiumSopranoLyrics = \lyricmode {
  Sa -- cri -- fi -- ci -- um %5
  De --
  o spi -- ri -- tus
  con -- tri -- bu -- la -- _
...
D-II-XIIBenigneSoprano = {
  \relative c' {
    \clef treble
    \key b \major \time 4/4 \autoBeamOff \tempoD-II-XIIBenigne
    r2 r4 r8 b'\fE
    es4 d8 c d c b d
...
D-II-XIIBenigneSopranoLyrics = \lyricmode {
  Be --
...
D-II-XIIGloriaSoprano = {
  \relative c' {
    \clef treble
    \key c \dorian \time 4/4 \autoBeamOff \tempoD-II-XIIGloria
...
D-II-XIIGloriaSopranoLyrics = \lyricmode {
  Glo --
  _ ri -- a Pa -- tri,
  glo --
  _ ri -- a Fi -- li -- o,
