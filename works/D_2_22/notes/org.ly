...
D-II-XIIMiserereOrgano = {
  \relative c {
    \clef bass
    \key c \dorian \time 4/4 \tempoD-II-XIIMiserere
    c2\fE h
    R1
    c2 b!
    as r
...
D-II-XIIMiserereBassFigures = \figuremode {
  <5>4 <6-> <7-> <6>
  r1
  <5 4>4 <\t 3> <4! _->2
  <5! 4->4 <6 3>2.
...
D-II-XIIAmpliusOrgano = {
  \relative c {
    \clef bass
    \key g \minor \time 3/4 \tempoD-II-XIIAmplius
    g4\pE r g
    c2 d4
    b2 es4
    c2 d4
...
D-II-XIIAmpliusBassFigures = \figuremode {
  r2.
  <6>2 <_+>4
  <6>2.
  <6->2 <[5!] _+>4
...
D-II-XIITibiSoliOrgano = {
  \relative c {
    \clef bass
    \key c \dorian \time 4/4 \tempoD-II-XIITibiSoli
    R1
    r4 c\fE b2~
    b a~
    a b
...
D-II-XIITibiSoliBassFigures = \figuremode {
  r1
  r2 <4! 2>
  <\t _+> <7 5! _+>4 <6 4>
  <5- 4> <\t _!> <10 9> <\t 8>
...
D-II-XIIEcceEnimOrgano = {
  \relative c {
    \clef bass
    \key g \minor \time 3/4 \tempoD-II-XIIEcceEnim
    g'4\fE fis r
    r g d
    b g b
    c es f
...
D-II-XIIEcceEnimBassFigures = \figuremode {
  r4 <6>2
  r <_+>4
  <6>2 q4
  r q2
...
D-II-XIIAspergesOrgano = {
  \relative c {
    \clef bass
    \key g \minor \time 2/1 \tempoD-II-XIIAsperges
...
D-II-XIIAspergesBassFigures = \figuremode {
  r\breve
  r
  r
  r
...
D-II-XIIAudituiOrgano = {
  \relative c {
    \clef bass
    \key es \major \time 3/4 \tempoD-II-XIIAuditui
    es4\fE r es
    es2 c4
    b2 g'4
    as2 as,4
...
D-II-XIIAudituiBassFigures = \figuremode {
  r2.
  r2 <5>8 <6!>
  r2 <6>4
  <9> <8>2
...
D-II-XIIAverteOrgano = {
  \relative c {
    \clef bass
    \key g \minor \time 4/4 \tempoD-II-XIIAverte
...
D-II-XIIAverteBassFigures = \figuremode {
...
D-II-XIINeProiciasOrgano = {
  \relative c {
    \clef bass
    \key b \major \time 3/4 \tempoD-II-XIINeProicias
...
D-II-XIINeProiciasBassFigures = \figuremode {
  r2.
  r
  r
  r
...
D-II-XIIDomineOrgano = {
  \relative c {
    \clef bass
    \key es \major \time 4/4 \tempoD-II-XIIDomine
    ...
    d4 r8 d es4 r8 es
    f4 r8 a b g es f %10
    \tempoD-II-XIIEtOs b,4 b8\fE b' a4 r8 f
    b4 r8 f d b r f'
    b4 b,8 b f' f, r f'
    b b, r a b4. f'8
    b b, g' es b' b d, b %15
...
D-II-XIIDomineBassFigures = \figuremode {
  r4 <6>2.
  <6> q8 <5>
  r4 <6>2.
  <[6]>2 <7>8 <6>16 q q8 <5>
...
D-II-XIIQuoniamOrgano = {
  \relative c {
    \clef bass
    \key c \dorian \time 3/4 \tempoD-II-XIIQuoniam
    c2.\fE
    f4 g2
    es r4
    r c2
...
D-II-XIIQuoniamBassFigures = \figuremode {
  r2.
  <6 _->4 <6 4> <5 _!>
  <6>2.
  r4 <6->2
...
D-II-XIISacrificiumOrgano = {
  \relative c {
    \clef bass
    \key f \dorian \time 4/4 \tempoD-II-XIISacrificium
...
D-II-XIISacrificiumBassFigures = \figuremode {
  r2 <6>4 <6 4>8 <6 5 [_-]>
...
D-II-XIIBenigneOrgano = {
  \relative c {
    \clef bass
    \key b \major \time 4/4 \tempoD-II-XIIBenigne
    b8\fE c d b g a b b'
    g4 g8 a b b, d b
    f'4 es8 d c4 d
    g8 fis g g, d'4 r
...
D-II-XIIBenigneBassFigures = \figuremode {
  r2 <6>
  <6>4 <5>8 <[6]> r2
...
D-II-XIIGloriaOrgano = {
  \relative c {
    \clef bass
    \key c \dorian \time 4/4 \tempoD-II-XIIGloria
    ...
    c4 g' c b! \noBreak
    as2 g4 r\fermata %10
    \clef "treble_8" \tempoD-II-XIIEtInSaecula c4-! c-! es-! \parOn d8-\parenthesize-! c-! \noBreak
...
D-II-XIIGloriaBassFigures = \figuremode {
  r1
