...
D-II-XIIMiserereTenoreLyrics = \lyricmode {
  Mi -- se -- re -- re,
...
D-II-XIIAmpliusTenoreLyrics = \lyricmode {
  Ab in -- %5
  i -- qui --
  ta -- te
  me --
...
D-II-XIITibiSoliTenore = {
  \relative c' {
    ...
    es( d8[ c)] d2~ \noBreak
    d r\fermata
    \tempoD-II-XIIUtIustificeris es8 c h d es c4 b?8~ \noBreak
    ...
    c c r c b4. b8 %20
    b b r g as4. b8
    c c r4 r \tempoD-II-XIICumIudicaris f
    f es d2
    c r\fermata \bar "||" %24 finis
  }
}

D-II-XIITibiSoliTenoreLyrics = \lyricmode {
  Pec -- ca -- %2
  _
  vi, pec -- ca -- _
  _ _ _ %5
...
D-II-XIIEcceEnimTenoreLyrics = \lyricmode {
  Ec -- ce,
  ec -- ce
  e -- nim in
  in -- i -- qui --
...
D-II-XIIAspergesTenoreLyrics = \lyricmode {
  A --
  sper --
  ges me __
  hys -- so -- po,
...
D-II-XIIAudituiTenoreLyrics = \lyricmode {
  Au --
  di -- tu -- i
  me -- o
  da --
...
D-II-XIIAverteTenoreLyrics = \lyricmode {
  A -- ver -- te, a -- ver -- te, a --
...
D-II-XIINeProiciasTenoreLyrics = \lyricmode {
  Ne pro -- %9
  i -- ci -- as, %10
  ne pro --
  i -- ci -- as
...
D-II-XIIDomineTenoreLyrics = \lyricmode {
  Do -- _ %3
  _ _ _ mi --
  ne, %5
...
D-II-XIIQuoniamTenoreLyrics = \lyricmode {
  Quo -- ni -- am
  si vo -- lu --
  is -- ses
  sa -- cri --
...
D-II-XIISacrificiumTenoreLyrics = \lyricmode {
  Sa -- %2
  cri -- fi -- ci -- um
  De -- o, sa --
  cri -- fi -- ci -- um %5
...
D-II-XIIBenigneTenoreLyrics = \lyricmode {
  Be -- ni -- gne, be --
...
D-II-XIIGloriaTenore = {
  \relative c' {
    ...
    \tempoD-II-XIIEtInSaecula c4 c es d8 c \noBreak
    d c h4 c r8 b
    c4 b8 es c8. c16 d4
    es f!8. f16 c4 as
    f g es4. es'8 %15
...
D-II-XIIGloriaTenoreLyrics = \lyricmode {
  Glo -- _ ri -- a,
  glo -- ri -- a Pa -- tri,
  glo -- _ ri -- a,
  glo -- ri -- a Fi -- li -- o,
