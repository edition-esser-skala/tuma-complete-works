...
D-I-IVDixitBassFigures = \figuremode {
  r1
  r2 <6>
  r4 <6>2 r8 q
  r <[6]> <7> <6\\> r2
...
D-I-IVConfiteborBassFigures = \figuremode {
  r8 <6> <_+> <\t> <6>2
  q <5!>8 <6> <7> <6>16 <5>
  r4. <_+>8 <6>4 <7>8 <_+>
  r4 <6\\>8 <6> <6! 4>4 <5 _+>
...
D-I-IVBeatusBassFigures = \figuremode {
  r2.. <6>8
...
D-I-IVPueriBassFigures = \figuremode {
  r2 <6>8 <[_+]>4.
  <_+>2 <5>4 <6>
...
D-I-IVLaudateOrgano = {
  \relative c {
    \clef bass
    \key d \dorian \time 2/2 \tempoD-I-IVLaudateDominum
    \mvTr d1-!\fE-\tuttiE
    d4-! c-! d-! e-!
    f2-! d-!
    e1-!
...
D-I-IVLaudateBassFigures = \figuremode {
  r1
  r
  r
  r
...
D-I-IVMagnificatBassFigures = \figuremode {
  r1
  r
  r2 <6 5>
  <7>4 <6\\>2.
