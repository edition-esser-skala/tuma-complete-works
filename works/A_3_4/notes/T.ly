...
A-III-IVKyrieTenoreLyrics = \lyricmode {
  E -- lei -- %3
  son, e --
  lei -- _ _ %5
  son, e -- lei -- _
...
A-III-IVGloriaTenore = {
  \relative c' {
    ...
    f r r2 %80
    R1
    r2 r4 \tempoA-III-IVCumSancto \mvTr f'\f^\tuttiE
    e f d4. d8
...
A-III-IVGloriaTenoreLyrics = \lyricmode {
  Et in ter -- ra
  pax, pax,
  pax ho -- mi -- ni -- bus
  bo -- nae
...
A-III-IVCredoTenoreLyrics = \lyricmode {
...
A-III-IVSanctusTenoreLyrics = \lyricmode {
  San -- ctus, %2
  san -- ctus,
...
A-III-IVBenedictusTenoreLyrics = \lyricmode {
  O -- san -- %18
  na, o -- san -- na in ex --
...
A-III-IVAgnusTenoreLyrics = \lyricmode {
  A -- gnus De -- i, qui
