...
C-III-XVIIIBasso = {
  \relative c {
    \clef bass
    \key g \minor \time 4/4 \autoBeamOff \tempoC-III-XVIIIVenite
    R1
    ...
    c8 es! es d cis2
    d4 d8 d b4 g \noBreak
    es'2 d4\fermata \tempoC-III-XVIIIEtEgo r \noBreak %15
    r r8 g f!8([ es)] f d \noBreak
    es8. es16 es8 c d4 d8 d
    g,4 r8 cis d4 d8 d \noBreak
    g,1\fermata \bar "||"
    \key d \minor \time 3/4 \tempoC-III-XVIIIPanis R2.*65 \noBreak %84
    R2.\fermata \bar "||" %85
    \key g \minor \time 4/4 \tempoC-III-XVIIIQui
      \mvTr g'4.\fE^\tuttiE g8 f f f f \noBreak
    es4 es8 es h4 h
    c d es4. es8 \noBreak
    d1
    \tempoC-III-XVIIIVivet r4 g8 b a g a g16([ fis)] \noBreak %90
    g8 g, r4 r2
...
C-III-XVIIIBassoLyrics = \lyricmode {
  Ve -- %2
  ni -- te, ve -- ni -- te, ve --
  ni -- te, ve -- ni -- te
  ad me o -- %5
