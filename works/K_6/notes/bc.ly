...
K-VIIntroContinuo = {
  \relative c {
    \clef bass
    \key f \dorian \time 4/4 \tempoK-VIIntro
...
K-VIIntroBassFigures = \figuremode {
  r8 r2 <6 5>4 <7 _!>
...
K-VIFugaContinuo = {
  \relative c {
    \clef bass
    \key f \major \time 4/4 \tempoK-VIFuga
    R1*10 %10
    r2 f\fE
    d'4. c8 b a g4~
...
K-VIFugaBassFigures = \figuremode {
  r1*11 %11
  <6>4. q8 q q q <5>
  <4> <\t> <6> q q q q <5>
  <4> <\t> <6> q q q q <5>
...
K-VIMenuetContinuo = {
  \relative c {
    \clef bass
    \key f \major \time 3/4 \tempoK-VIMenuet
    r4 f-!\fE g-!
    a-! b-! c-!
    ...
    f c' c, \noBreak
    f2 r4\fermata \bar ":|.|:"
    \key b \major \tempoK-VIMenuetB \mvTr r4\p-\sempre b b, \noBreak %35
    r b' b,
    r b' b,
    r f' f,
    b b'2~
...
K-VIMenuetBassFigures = \figuremode {
  r2.
  r
  r
  <5>
...
K-VICapricioContinuo = {
  \relative c {
    \clef bass
    \twotwotime \key f \major \time 2/2 \tempoK-VICapricio
    f2\fE c
    r4 b b8 c d e
    f4 f, f'2
    g c,
...
K-VICapricioBassFigures = \figuremode {
  r1
  r
  <6 4>2 <5 3>
  <9 4> <7 5>
