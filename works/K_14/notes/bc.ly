...
K-XIVAllegroContinuo = {
  \relative c {
    \clef bass
    \key c \major \time 4/4 \tempoK-XIVa
    c4\fE r r2
    R1
    c4 r f\p r
...
K-XIVAllegroBassFigures = \figuremode {
  r1
  r
  <7->
  q
...
K-XIVAndanteContinuo = {
  \relative c {
    \clef bass
    \twofourtime \key f \major \time 2/4 \tempoK-XIVb
...
K-XIVAndanteBassFigures = \figuremode {
  r8 r <6> q4
  <\t>8 <7> <4> <6>
  <4> <7> <6 5>4
  <4>8 <6> <4> <3>
...
K-XIVMenuettoContinuo = {
  \relative c {
    \clef bass
    \key c \major \time 3/4 \tempoK-XIVc
    c4\fE e d
    c8 d e d c4
    d2 c4
    h g c
    ...
    a g g, \noBreak
    c g c,\fermata \bar ":|.|:"
    \key c \dorian \tempoK-XIVcb r4 c'8 c c4 \noBreak %25
    r c'8 c c4
    f, r f
    g d g,
    r f'8 f f4
...
K-XIVMenuettoBassFigures = \figuremode {
  r4 <6> q
  r8 q q q4.
  <6>2 <6 4>4
  <6 5>2.
...
K-XIVFinaleContinuo = {
  \relative c {
    \clef bass
    \twofourtime \key c \major \time 2/4 \tempoK-XIVd
    c4\fE f
    g c,
    h h'
    c c,
...
K-XIVFinaleBassFigures = \figuremode {
  r4 <6>
  <4>8 <3>4.
  <6>4 <7>8 <6>16 <5>
  <9 4>4 <8 3>
