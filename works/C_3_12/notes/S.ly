...
C-III-XIISoprano = {
  \relative c' {
    \clef treble
    \key a \major \time 4/4 \autoBeamOff \tempoC-III-XIILaudes
    R1*30 \noBreak %30
    R1\fermata \bar "||"
    \time 3/4 \tempoC-III-XIITu \newSpacingSection
    ...
    gis gis4. gis8 \noBreak %50
    fis2.\fermata \bar "||"
    \key d \major \time 4/4 \tempoC-III-XIISint
      R1*31 \noBreak %82
    R1\fermata \bar "||"
    \key a \major \time 3/4 \tempoC-III-XIISummae \newSpacingSection
...
C-III-XIISopranoLyrics = \lyricmode {
  Tu %32
  san -- cta spes
  fi -- des,
  a -- mor al -- %35
