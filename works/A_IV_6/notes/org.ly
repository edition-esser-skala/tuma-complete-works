...
AIVviOrgano = {
  \relative c {
    ...
    g fis e8. d16 cis4
    d8 g a4 h g8 a %15
    d,2 \tempoAIVviQuamB d\pE
    d1\fermata
    \tempoAIVviQuamC d8 d g g fis fis fis d \markCritnote \bar "S-S"
    ...
    \time 3/4 \tempoAIVviQuamD g,4\p r r \noBreak
    r8 g( g g g g) %55
    g( g g g g g)
    g( g g g g g)
    g( g g g g g)
    ...
    fis, \noBreak %75
    h\fermata \bar "||"
    \time 4/4 \tempoAIVviQuamE d8\fE d d d a' a a, a \noBreak
    d d g\pE g fis fis fis d \markDSAF \bar "S-S"
    \key g \major \tempoAIVviQuia h1~\pE \noBreak
    h %80
    c~
    c~
    c2 cis4 r \noBreak
    r d g, r\fermata \bar "||"
    \tempoAIVviAmen g'8\pE a h fis g a h fis \noBreak %85
