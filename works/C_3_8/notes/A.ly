...
C-III-VIIIAlto = {
  \relative c' {
    \clef treble
    \key e \minor \time 4/4 \autoBeamOff \tempoC-III-VIIIVilescit
    r4 \mvTr h'\pE^\soloE g8 g r a16 h
    ...
    a4 a r a
    a dis, g! dis8 e \noBreak %15
    h h r4 r2\fermata \bar "||"
    \key a \minor \time 2/4 \tempoC-III-VIIIOter
      R2*24 %40
    a'4 e8. c16
    a4 a' \noBreak
    gis r \bar "S-S"
    ...
    a4 e8. c16
    a4 a' \noBreak
    gis r \markCritnote \bar "S-S"
    \key a \minor \time 4/4 \tempoC-III-VIIIInter
      e4 e cis cis8 e \noBreak %195
    e a, r4 r8 e' fis g
    fis4 fis r8 cis cis d
    e8. e16 e8 dis dis4 dis
    r h'8 fis16 g e8 e r h
    e e e h c4 c %200
    r c8 a dis4 r
    r e8. e16 e8 h r4
    r r8 h' gis8 gis r a16 h
    h8 cis, r gis'16 a h4 a8 gis
    a8. a16 a4 r fis8 a %205
    gis4 gis8 gis gis dis r dis16 e
    fis4 fis8 e cis cis r4
    r gis' eis8. eis16 eis8 fis
    gis2 gis4 r8 gis
    gis cis, cis fis dis8. dis16 dis4 %210
    r g8 e ais4 ais8 h \noBreak
    h fis r4 r2\fermata \bar "||"
    \key e \minor \tempoC-III-VIIIOvera
      \set Score.currentBarNumber = #212
      \partial 8 r8 \noBreak R1*9 %221
    r4 r8 h h e, r g
    fis h, r h' h([ ais)] fis a
    g16([ fis)] e8 r g a4 g8 fis
    \sbOn \tuplet 3/2 8 { g16[ h a h a g] a[ c h c h a] } \sbOff h4 r8 g %225
    e8.([ c'16)] h([ a)] g([ fis)] g4 r
    R1
    r2 r4 r8 d'
    d g, r h a d, r g
    e([ c')] h a h16([ a)] g8 r h %230
    h([ ais)] h, a' a g r g
    g([ f)] g, f' f e r gis
    \sbOn \tuplet 3/2 8 { a16[ c h c h a] h[ d c d c h] } \sbOff c[ d e gis,] a[ h c fis,]
    \sbOn \tuplet 3/2 8 { g[ h a h a g] a[ c h c h a] } \sbOff h[ c d fis,] g[ a h e,]
    c'[ h a g] a[ g] fis e dis4 r8 fis %235
    g fis r fis g fis r h
    c h r h c([ h)] e, d'!
    c16([ h)] a8 r c h8.([ a16)] g([ fis)] e([ dis)]
    e4 r8 a a4\fermata r8 a
    g16([ fis e c'] h[ a)] g fis e4 r8 a %240
    a4 r8 a g4~ \sbOn \tuplet 3/2 8 { g16[ h a g fis e] } \sbOff
    fis4. e16^\critnote fis e4 r
    R1*5 %247
    r4\fermata r8 g a g r h
    a16([ fis)] d8 r d g16([ fis)] g8 r f
    f e r e a16([ gis)] a8 r g %250
    g fis r4 r fis8 h
    h4 ais r e8 e
    e4 d8 fis g([ h) g( fis)]
    eis4~ eis16[ cis'( h) eis,] fis8([ a) fis( e?)]
    dis4~ dis16[ h'( a) dis,] e8[ h' g fis] %255
    e4 eis8 eis16 eis fis4 r8 h,
    a'! g r a, g' fis fis h
    e,4. g8 g([ fis)] fis([ e)]
    d([ fis)] h cis cis4. h16 cis
    h4 r r2 \markDaCapo \bar "||" %260
  }
}

C-III-VIIIAltoLyrics = \lyricmode {
  Vi -- le -- scit mi -- hi
  ...
  In -- ter tan -- ta pe -- %195
  ri -- cla quae cor -- di
  no -- stro fal -- la -- ces
  in -- ter vo -- lu -- pta -- tes
  mun -- dus mo -- li -- tur, quis
  men -- tem ex -- pli -- ca -- bit? %200
  Si -- ne te,
  san -- ctus a -- mor?
  O a -- mor! O ju --
  cun -- da, o su -- a -- vis di --
  le -- cti -- o! Ec -- quis %205
  te tan -- dem di -- gno ce -- le --
  bra -- bit ho -- no -- re?
  Tu si -- de -- re se --
  re -- no, tu
  so -- lus in -- ter re -- li -- qua %210
  ful -- ges cla -- ri -- os
  a -- stra.
  ...
  ten -- ti es prae -- vi -- a
  fax, tu es, es
  prae -- vi -- a fax, tu %240
  es, es prae --
  _ vi -- a fax.

  Iam sper -- no mun -- %248
  da -- nos dum cer -- no non
  va -- nos, dum cer -- no non %250
  va -- nos coe -- li
  flo -- res et a --
  mo -- res qui sa --
  _ _
