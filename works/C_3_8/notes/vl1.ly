...
C-III-VIIIViolinoI = {
  \relative c' {
    ...
    h4 r r cis,-! %5
    \tuplet 3/2 8 { \sbOn d16 h d fis d fis h, fis h fis d fis \sbOff } h,4 r
    c'!2\p h~
    h1~
    h~
    h2 \tuplet 3/2 8 { \sbOn a16\f cis, fis fis cis fis a fis a cis a cis \sbOff } %10
    fis2~\p fis4 \tuplet 3/2 8 { \sbOn a16 fis a fis dis fis \sbOff }
    c!2 f~
    f eis
    fis!1
    dis2 e4 r \noBreak %15
    r dis-!\f e-! r\fermata \bar "||"
    ...
    \tuplet 3/2 4 { c8 h a } r4
    R2 \noBreak
    r4 \tuplet 3/2 4 { h8\fE c d } \markCritnote \bar "S-S"
