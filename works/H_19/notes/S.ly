...
H-IXKyrieSoprano = {
  \relative c' {
    \clef treble
    \key g \minor \time 4/4 \autoBeamOff \tempoH-IXKyrie
    R1*6 %6
...
H-IXKyrieSopranoLyrics = \lyricmode {
  Ky -- ri -- e e -- %7
  lei --
  son, e -- lei --
  son, e -- %10
...
H-IXSanctaSoprano = {
  \relative c' {
    \clef treble
    \key d \phrygian \time 3/4 \autoBeamOff \tempoH-IXSancta
    \mvTr d'2\fE^\tutti d4
...
H-IXSanctaSopranoLyrics = \lyricmode {
  San -- cta,
  san -- cta Ma --
  ri -- a,
  san -- cta
...
H-IXSpeculumSoprano = {
  \relative c' {
    \clef treble
    \key g \minor \time 4/4 \autoBeamOff \tempoH-IXSpeculum
    R1*10 %10
...
H-IXSpeculumSopranoLyrics = \lyricmode {
...
H-IXSalusSoprano = {
  \relative c' {
    \clef treble
    \key g \minor \time 4/4 \autoBeamOff \tempoH-IXSalus
    \mvTr d'2.\fE^\tutti d4
    d d d( c
    h2) a
    r4 c c4. c8
    ...
    b b b b \noBreak
    a g g( fis) \bar "||" %10
    \tempoH-IXRegina g4 \mvTr d'\pE^\soloE es8 d16([ c)] f8 es \noBreak
    d16([ c)] b8 r f' d c b4
...
H-IXSalusSopranoLyrics = \lyricmode {
  Sa -- lus
  in -- fir -- mo --
  rum,
  re -- fu -- gi --
...
H-IXSubTuumSoprano = {
  \relative c' {
    \clef treble
    \key g \minor \time 4/4 \autoBeamOff \tempoH-IXSubTuum
...
H-IXSubTuumSopranoLyrics = \lyricmode {
  Sub tu -- um prae --
