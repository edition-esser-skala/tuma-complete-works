...
H-IXKyrieTenoreLyrics = \lyricmode {
  Ky -- ri -- %8
  e e -- lei --
  son, e -- %10
  lei -- son,
...
H-IXSanctaTenoreLyrics = \lyricmode {
  San -- cta,
  san -- cta Ma --
  ri -- a,
  san -- cta
...
H-IXSpeculumTenoreLyrics = \lyricmode {
  Vas spi -- ri -- tu -- %24
  a -- le, %25
  vas ho -- no --
  ra -- bi -- le,
...
H-IXSalusTenore = {
  \relative c' {
    ...
    c4 c8 c b4 b8 b %50
    es4. es8 a,4 a
    \tempoH-IXMiserere r d8 d es4 es
...
H-IXSalusTenoreLyrics = \lyricmode {
  Sa -- lus
  in -- fir -- mo --
  rum,
  re -- fu -- gi --
...
H-IXSubTuumTenoreLyrics = \lyricmode {
  In __ %3
  ne -- ces -- si -- ta -- ti -- bus
