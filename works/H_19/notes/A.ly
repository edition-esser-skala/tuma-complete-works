...
H-IXSanctaAltoLyrics = \lyricmode {
  San -- cta,
  san -- cta Ma --
  ri -- a,
  san -- cta
...
H-IXSpeculumAltoLyrics = \lyricmode {
  Vas spi -- ri -- tu -- %24
  a -- le, %25
  vas ho -- no --
  ra -- bi -- le,
...
H-IXSalusAlto = {
  \relative c' {
    ...
    r g g g \noBreak
    fis b a2 \bar "||" %10
    \tempoH-IXRegina d,4^\critnote r r2 \noBreak
    R1*10 %21
...
H-IXSubTuumAltoLyrics = \lyricmode {
