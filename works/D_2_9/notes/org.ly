...
D-II-IXDixitBassFigures = \figuremode {
  r4 <7>2.
  r4. <6>4 <[6]>8 <7> q
...
D-II-IXTecumOrgano = {
  \relative c {
    \clef bass
    \key g \major \time 3/4 \tempoD-II-IXTecum
...
D-II-IXTecumBassFigures = \figuremode {
  r4 <6>2 %38
  r4 <7> q
  r2 <6>4 %40
  r <7> <_+>
...
D-II-IXIuravitOrgano = {
  \relative c {
    ...
    \mvTr h1\p-\senzaOrg \noBreak
    h\fermata \bar "||"
    \clef "treble_8" \tempoD-II-IXEtNon
    ...
    \tempoD-II-IXDominus c, h\pE c a h a gis e \noBreak
    ...
    g, r g r8 \tempoD-II-IXImplebit \mvTr g'\f-\colOrg \noBreak
...
D-II-IXIuravitBassFigures = \figuremode {
  r1 %126
  <4 2\+>2 <6 5 [_+]>
  r1
  r
...
D-II-IXDeTorrenteChords = {
  \relative c' {
    \clef treble
    \key g \major \time 3/4 \tempoD-II-IXDeTorrente
...
D-II-IXDeTorrenteBassFigures = \figuremode {
  r2. %177
  r
  r4 <6> <5>
  r2 \bo <[6]>4 %180
...
D-II-IXGloriaOrgano = {
  \relative c {
    ...
    r4 c h2
    c g
    \tempoD-II-IXGloriaB \mvTr c8\pE-\soloE d e c f a16 h c8 c, %245
    d e f g c,4\fE d8 g
    c, e\pE h g c4 r8 h
    c4 r8 h c d e f
...
D-II-IXGloriaBassFigures = \figuremode {
  r2 <6> %241
  r1
  r2 <6>
  <9>4 <8>2.
